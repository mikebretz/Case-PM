  ...
  function ensurePrintSheetStyles(bodyClass) {
    ...
    style.textContent = `
      @media print {
        ...
        body.printing-co-log #coDetailView,
        ...
        body.printing-rfi-log #rfiChrome,
        body.printing-rfi-log #rfiDetailView,
        ...
        body.printing-rfi-detail #rfiChrome,
        body.printing-rfi-detail #rfiDetailView,
