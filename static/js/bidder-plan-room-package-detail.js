      ...
      host.innerHTML = `
        ...
        <div class="pr-detail-grid">
          <section class="pr-panel">
            ...
            ${itb.scope_summary_html ? `<div class="pr-html-content">${itb.scope_summary_html}</div>` : ''}
            ${itb.instructions_html ? `<div class="pr-html-content">${itb.instructions_html}</div>` : (pr.instructions_html ? `<div class="pr-html-content">${pr.instructions_html}</div>` : '')}
            ${itb.qualifications_html ? `<div class="pr-itb-block"><h3>Qualifications</h3><div class="pr-html-content">${itb.qualifications_html}</div></div>` : ''}
