...
(function (global) {
    ...
    const FIELDS = [
        ...
        { id: 'percent_complete_type', label: '% Complete Type', map_to: 'percent_complete_type', type: 'select', group: 'Progress', desc: 'Duration, Physical, or Units' },
        { id: 'schedule_percent_complete', label: 'Schedule % Complete', map_to: 'schedule_percent_complete', type: 'readonly', group: 'Progress', desc: 'Earned schedule percent' },
        ...
        { id: 'actual_cost', label: 'Actual Cost', map_to: 'actual_cost', type: 'number', group: 'Cost', desc: 'Actual cost of work performed (ACWP)' },
        { id: 'fixed_cost', label: 'Fixed Cost', map_to: 'fixed_cost', type: 'number', group: 'Cost', desc: 'Fixed cost amount' },
        { id: 'bcws', label: 'BCWS', map_to: 'bcws', type: 'readonly', group: 'EVM', desc: 'Budgeted cost of work scheduled' },
        { id: 'bcwp', label: 'BCWP', map_to: 'bcwp', type: 'readonly', group: 'EVM', desc: 'Budgeted cost of work performed (earned value)' },
        { id: 'acwp', label: 'ACWP', map_to: 'acwp', type: 'readonly', group: 'EVM', desc: 'Actual cost of work performed' },
        { id: 'cpi', label: 'CPI', map_to: 'cpi', type: 'readonly', group: 'EVM', desc: 'Cost performance index (BCWP/ACWP)' },
        { id: 'spi', label: 'SPI', map_to: 'spi', type: 'readonly', group: 'EVM', desc: 'Schedule performance index (BCWP/BCWS)' },
        { id: 'cost_variance', label: 'Cost Variance', map_to: 'cost_variance', type: 'readonly', group: 'EVM', desc: 'BCWP − ACWP' },
        { id: 'schedule_variance', label: 'Schedule Variance', map_to: 'schedule_variance', type: 'readonly', group: 'EVM', desc: 'BCWP − BCWS' },
        { id: 'baseline_start', label: 'Baseline Start', map_to: 'baseline_start', type: 'readonly', group: 'Baseline', desc: 'Start date from active baseline' },
        { id: 'baseline_finish', label: 'Baseline Finish', map_to: 'baseline_finish', type: 'readonly', group: 'Baseline', desc: 'Finish date from active baseline' },
        { id: 'start_variance', label: 'Start Variance', map_to: 'start_variance', type: 'readonly', group: 'Baseline', desc: 'Days early (−) or late (+) vs baseline start' },
        { id: 'finish_variance', label: 'Finish Variance', map_to: 'finish_variance', type: 'readonly', group: 'Baseline', desc: 'Days early (−) or late (+) vs baseline finish' },
        ...
        { id: 'activity_type', label: 'Activity Type', map_to: 'activity_type', type: 'select', group: 'Codes', desc: 'Task, LOE, Resource Dependent, etc.' },
