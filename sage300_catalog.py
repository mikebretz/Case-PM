...
SAGE300_MODULES = [
    ...
    },
    {
        'id': 'jc',
        'code': 'JC',
        'name': 'Job Cost (CRE labor & burden)',
        'edition': 'cre',
        'summary': 'Labor, equipment, and burden posted to job cost from field and payroll.',
        'features': ['Timesheet cost', 'Equipment hours', 'Burden allocation', 'Job cost actuals'],
        'web_api': None,
        'integration': 'bridge',
        'casepm': {
            'bridge_module': 'JobCost',
            'events': ['TimesheetPosted', 'DirectCostPosted', 'EquipmentDailyLogPosted'],
            'ui': ['timesheets', 'daily_log', 'accounting'],
        },
    },
    {
        'id': 'cp',
        'code': 'CP',
        'name': 'Contract Progress (billing & revenue)',
        'edition': 'cre',
        'summary': 'Progress billing, revenue recognition, and WIP adjustments tied to contracts.',
        'features': ['G702 billing', 'WIP adjustments', 'Retainage', 'Revenue recognition'],
        'web_api': None,
        'integration': 'bridge',
        'casepm': {
            'bridge_module': 'ProgressBilling',
            'events': ['G702Approved', 'G702Submitted', 'WipAdjustmentPosted', 'RetainageReleased'],
            'ui': ['pay_applications', 'accounting', 'forecast'],
        },
    },
    {
        'id': 'cre_pb',
